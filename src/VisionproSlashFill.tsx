...
export default function VisionproSlashFill({
  className = 'w-6',
  color = '#000000',
}: {
  className?: string
  ...
  return (
    <svg version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 33.4964 26.2758' className={className}>
      <path
        d='M23.2635 21.5401C20.285 20.5909 18.4584 18.1232 16.563 18.1232C14.2061 18.1232 11.9819 21.9098 7.51875 21.9098C3.19297 21.9098 0 17.9767 0 12.7979C0 7.94635 2.41122 5.57045 6.20126 4.43085ZM33.1351 12.7979C33.1351 17.477 30.5286 21.1392 26.8245 21.7917L8.92359 3.83454C11.2009 3.48335 13.7997 3.4007 16.563 3.4007C25.7544 3.4007 33.1351 4.31438 33.1351 12.7979Z'
        fill={color}
        fillOpacity='0.85'
      />
      <path
